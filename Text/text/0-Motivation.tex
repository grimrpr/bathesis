...
%mehr Quellen anbringen !!  (Aufzählen: innerhalb von Gebäuden,
%Untergrund...(Signalabschirmung), ungenau Mehrwegeausbreitung in urbanen
%Umgebungen)
...
%Hierbei wird auch auf vergleichsweise low-cost Komponenten, wie beispielsweise
%der\textit{Microsoft Kinect} zurückgegriffen.

  %-kurz halten: -Signallaufzeitmessung -zwei Arten von Knoten feste anchor
  %Knoten mit bekannter Position -restliche Knoten sind mobil
  %-Positionsbestimmung?
  %
  %-Notwendigkeit zum Test weil: -Laufzeitmessung fehlerbehaftet
  %-Mehrwegausbreitung indoor -viele Stellschrauben der Positionsbestimmung
