...
untereinander auf unterschiedlichen Rechnern ausgeführt werden. Dies ist eines
der wichtigsten lässt sich
beispielsweise vorteilhaft ausnutzen durch:
...
Daten. ROS bietet in seinen Kernpakten bereits zahlreiche Definitionen
...
andere \textit{nodes} im ROS über den \textit{master} sichtbar.  Eine
...
\textit{topic-id} dient zur eindeutigen Identifikation innerhalb des ROS.
...
werden können. Beispielsweise basiert das ROS build System auf cmake und
...
\textit{Pathcompare} ist also, im Bezug auf ROS, während der Ausführung
