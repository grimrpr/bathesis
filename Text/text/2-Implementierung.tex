...
\begin{itemize}
  \item Anzahl der Lokalisierungspunkte
...
Punkt zusammen. $M$ sei demnach wie folgt definiert:
...
Die konkrete Repräsentierung des Modells erfolgt in Main Compare durch die
Klassen \textit{TopicPath} und \textit{Position}. TopicPath repräsentiert dabei
$M$. Position repräsentiert ein einzelnes Tupel. Dem Modell entsprechend enthält ein TopicPath
Objekt eine Liste von Position Objekten.

Anhand der abstrakten Modellierung eines Pfades, werden im Folgenden, die von
Main Compare ausgeführten, Berechnungen erläutert. 

- Klassen vorstellen, beschreiben, welche M in Main Compare repräsentieren

\subsubsection{Pfadvergleichsverfahren}
Als Grundlage für alle aufgeführten Features dienen die über des ROS
bereitgestellten Pfad \textit{messages}.
