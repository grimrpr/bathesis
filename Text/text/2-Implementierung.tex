...
Tabbellenstruktur. In dieser Tabelle ist für jede Pfad topic ein Spalte
angelegt.
...
aktualisiert.
Um nachzuvollziehen wie die aufgeführten Informationen ermittelt werden, bietet
...
Zunächst ist zu erkennen dass dieser \textit{message} Typ aus anderen Typen
zusammengesetzt ist. Auf der obersten Ebene ist dies ein
\textit{Header} und ein Array von \textit{geometry\_msgs/PoseStamped} messages.
